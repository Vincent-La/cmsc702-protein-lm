...
#SBATCH --job-name=rrm_contacthead_inference                     # sets the job name
#SBATCH --output=rrm_contacthead_inference.%j                    # indicates a file to redirect STDOUT to; %j is the jobid. If set, must be set to a file instead of a directory or else submission will fail.
#SBATCH --error=rrm_contacthead_inference.%j                     # indicates a file to redirect STDERR to; %j is the jobid. If set, must be set to a file instead of a directory or else submission will fail.
